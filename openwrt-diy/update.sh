...
#gost
svn co https://github.com/kenzok8/openwrt-packages/trunk/luci-app-gost ./luci-app-gost
svn co https://github.com/kenzok8/openwrt-packages/trunk/gost ./luci-app-gost/gost
#OAF
