...
svn checkout https://github.com/Lienol/openwrt-package/trunk/new-openvpn-Luci/luci-app-openvpn-server
svn checkout https://github.com/Lienol/openwrt-package/trunk/new-openvpn-Luci/luci-app-openvpn-client
